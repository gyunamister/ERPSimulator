...
public class RelativeLayout implements LayoutManager2, java.io.Serializable
{
	 ...
	 * @see	   org.processmining.actionorientedprocessmining.UI.RelativeLayout#minimumLayoutSize
	 ...
	 *			 subcomponents of the specified container
	 * @see		 org.processmining.actionorientedprocessmining.UI.RelativeLayout#preferredLayoutSize
